...
"fixtures" => [
    ...
    ["Cercle Brugge", "Oud Herverlee Leuven"],
    ["Charleroi", "Westerlo"],
    ["Antwerp", "La Louviere"],
    ["STVV", "Standard"],
    ["Gent", "Genk"],
